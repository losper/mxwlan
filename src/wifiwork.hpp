...
typedef int (*PFN_mxwConnect)(LPTSTR ssid,LPTSTR pwd);
typedef int (*PFN_mxwDisconnect)();
typedef int (*PFN_mxwGetListSize)();
typedef int (*PFN_mxwScan)();
typedef int (*PFN_mxwGetWnetwork)(tag_NetWork& tag,DWORD idx);
typedef tag_NetWork& (*PFN_mxwGetCurNetwork)();
template<typename T>
class xwifi{
public:
...
private:	
	...
	xwifi(){
		hdll=LoadLibrary(L"/nand/t9/mxwlan.dll");
		mxwConnect=(PFN_mxwConnect)GetProcAddressW(hdll, L"mxwConnect");
		mxwDisconnect=(PFN_mxwDisconnect)GetProcAddressW(hdll, L"mxwDisconnect");
		mxwGetListSize=(PFN_mxwGetListSize)GetProcAddressW(hdll, L"mxwGetListSize");
		mxwScan=(PFN_mxwScan)GetProcAddressW(hdll, L"mxwScan");
		mxwGetWnetwork=(PFN_mxwGetWnetwork)GetProcAddressW(hdll, L"mxwGetWnetwork");
		mxwGetCurNetwork=(PFN_mxwGetCurNetwork)GetProcAddressW(hdll, L"mxwGetCurNetwork");
	}
private:
	HMODULE hdll;
	PFN_mxwConnect mxwConnect;
	PFN_mxwDisconnect mxwDisconnect;
	PFN_mxwGetListSize mxwGetListSize;
	PFN_mxwScan mxwScan;
	PFN_mxwGetWnetwork mxwGetWnetwork;
	PFN_mxwGetCurNetwork mxwGetCurNetwork;
};
